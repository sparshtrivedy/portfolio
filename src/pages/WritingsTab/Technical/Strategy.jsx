            ...
            <Grid item xs={12} sm={8}>
                <Paper elevation={3}>
                    <Box sx={{ p: {xs: 2, sm: 4} }}>
                        ...
                        <Divider />
                        {isSm? 
                            <img src={strategy} alt={'Strategy Design Pattern'} style={{marginTop: '20px'}} />:
                            <img src={strategy} alt={'Strategy Design Pattern'} style={{marginTop: '20px', width: '100%'}} />
                        }
                        ...
                        <div style={{margin: '40px 0'}}>
                            ...
                            {isSm?
                                <img src={structureStrategy} alt={'Structure of the strategy design pattern'} style={{marginTop: '20px'}} />:
                                <img src={structureStrategy} alt={'Structure of the strategy design pattern'} style={{marginTop: '20px', width: '100%'}} />
                            }
                        </div>
                        <div style={{margin: '40px 0'}}>
