            ...
            <Grid item xs={12} sm={8}>
                <Paper elevation={3}>
                    <Box sx={{ p: {xs: 2, sm: 4} }}>
                        ...
                        <Divider />
                        {isSm? 
                            <img src={codecomments} alt={'Code comments illustration'} style={{marginTop: '20px'}} />:
                            <img src={codecomments} alt={'Code comments illustration'} style={{marginTop: '20px', width: '100%'}} />
                        }
