                ...
                <Paper elevation={3}>
                    <Box sx={{ p: {xs: 2, sm: 4} }}>
                        ...
                        {isSm? 
                            ...
                            <img src={singleton} alt={'Singleton Design Pattern'} style={{marginTop: '20px', width: '100%'}} />
                        }
                        ...
                        <div style={{margin: '40px 0'}}>
                            ...
                            {isSm?
                                <img src={structureSingleton} alt={'Structure of the singleton design pattern'} style={{marginTop: '20px'}} />:
                                <img src={structureSingleton} alt={'Structure of the singleton design pattern'} style={{marginTop: '20px', width: '100%'}} />
                            }
                        </div>
                        <div style={{margin: '40px 0'}}>
